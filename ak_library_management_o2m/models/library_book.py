...
class LibraryBook(models.Model):
    ...
    category_id=fields.Many2one(string='Book Category',comodel_name='library.book.category')
    ...
    library_id = fields.Many2one(string='Library',comodel_name='library.library')
    tags_ids = fields.Many2many(string='Tags',comodel_name='library.book.tag',related='category_id.tags_ids')
